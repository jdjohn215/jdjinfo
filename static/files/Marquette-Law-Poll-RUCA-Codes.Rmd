...
crosstab(integ %>% filter(zendyyyy == 2020), 
  ...
  tab_header(title = "Biden vs Trump by RUCA code",
             subtitle = "Wisconsin registered voters, all 2020 polls through August")
```
