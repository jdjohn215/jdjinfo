...
Still, not all of Milwaukee's neighborhoods are characterized by racial segregation. Among [Milwaukee's 186 neighborhoods](https://city.milwaukee.gov/Neighborhoods), 73 have a (non-Latinx) Black majority, 72 have a (non-Latinx) white majority, 14 are majority Latinx (of any race), and 27 have no majority group. Between 4 and 5 percent of Milwaukee's population is Asian, but Asian residents do not make up a majority of any individual neighborhood's population. I calculated these statistics by (dis)aggregating data from the 2018 5-year American Community Survey into neighborhood boundaries using [the methodology described here](https://github.com/jdjohn215/Milwaukee-Geo-Crosswalks). Similarily, Piggsville (also called "The Valley") has 36% Black residents, 34% white, 16% Latinx, and 11% Asian.[^1]

The 27 neighborhoods without a majority group are arranged in descending order by total population as follows: `r paste(no.majority)`.
